...
class TestParseSchemaFromUrl(unittest.TestCase):
    ...
    def test_multiple_options_with_search_path(self):
        ...
        url = "postgresql://user:pass@localhost:5432/mydb?options=-csynchronous_commit%3Dlocal%20-csearch_path%3Dmy_schema"
        result = PostgresLoader._parse_schema_from_url(url)
        self.assertEqual(result, 'my_schema')
