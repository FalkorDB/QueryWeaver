...
def llm_answer_validator(question: str, answer: str, tables: list[str]) -> float:
    prompt = """
    You are evaluating an answer generated by a text-to-sql RAG-based system. Assess how well the generated sql addresses the question
    and whether it includes the necessary tables or columns.
    ...
    Provide a relevance score from 0 to 1 (1 being a perfect response) and justify your reasoning.
    Output Json format:
